...
D3D_EXPORT
void D3DAPI PROXY_D3DXMatrixInverse(
...
D3D_EXPORT
void D3DAPI PROXY_D3DXMatrixMultiply(
	_Inout_       DirectX::XMMATRIX *pOut,
...
D3D_EXPORT
void D3DAPI PROXY_D3DXMatrixMultiplyTranspose(
	_Inout_       DirectX::XMMATRIX *pOut,
	_In_    const DirectX::XMMATRIX *pM1,
	_In_    const DirectX::XMMATRIX *pM2
)
...
D3D_EXPORT
void D3DAPI PROXY_D3DXMatrixTranspose(
	_Inout_       DirectX::XMMATRIX *pOut,
	_In_    const DirectX::XMMATRIX *pM
)
{
...
D3D_EXPORT
void D3DAPI PROXY_D3DXPlaneNormalize(
...
D3D_EXPORT
void D3DAPI PROXY_D3DXPlaneTransform(
	_Inout_       DirectX::XMVECTOR *pOut,
	_In_    const DirectX::XMVECTOR *pP,
	_In_    const DirectX::XMMATRIX *pM
)
...
D3D_EXPORT
D3DXVECTOR3* D3DAPI PROXY_D3DXVec3Normalize(
...
D3D_EXPORT
D3DXVECTOR3* D3DAPI PROXY_D3DXVec3TransformCoord(
	_Inout_       D3DXVECTOR3		*pOut,
	_In_    const D3DXVECTOR3		*pV,
	_In_    const DirectX::XMMATRIX	*pM
)
...
D3D_EXPORT
D3DXVECTOR3* D3DAPI PROXY_D3DXVec3TransformNormal(
	_Inout_       D3DXVECTOR3		*pOut,
	_In_    const D3DXVECTOR3		*pV,
	_In_    const DirectX::XMMATRIX	*pM
)
